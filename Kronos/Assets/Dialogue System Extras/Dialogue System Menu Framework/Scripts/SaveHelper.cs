...
namespace PixelCrushers.DialogueSystem.MenuSystem
{
    ...
    {
        [Tooltip("The panel to be opened when Start game is clicked, but there are no saved games")]
        public GameObject saveSlotsPanel;

        [Tooltip("The panel to be closed when Start game is clicked, but there are no saved games")]
